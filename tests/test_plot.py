    ...
    expected_output = pd.DataFrame(
        {
            ...
            "grid": ["grid1", "grid2"],
            "cni": [
                "featuresCNI1-targetsCNI1-matching1",
                "featuresCNI2-targetsCNI2-matching2",
            ],
        }
    )

    assert process_results(available_results).equals(
        expected_output
    ), "result dataframe processed incorrectly"
...
def test_plot():
    ...
    stats = [
        {
            "x": [10, 20, 30],
            "y_mean": [-0.013438467691572267, -0.5122605335838996, -0.248453755907222],
            "y_std": [0.02327610881767601, 0.9270180816941317, 0.1085962028735548],
        },
        {
            "x": [10, 20, 30],
            "y_mean": [0.001029732130729, -0.24388659377273078, -0.9252934714314738],
            "y_std": [0.0017835483686087852, 0.21380769781674483, 1.2665951095048933],
        },
    ]
