...
def test_aggregate():
    ...
    num_of_files = 5
    score_files = [
        "tests/data/aggregate_input_" + str(i) + ".csv"
    ...
    # # #
    sample_data = [
        {"n": 100, "s": 1, "r2_val": 0.0, "acc_val": 0.9},
        {"n": 100, "s": 2, "r2_val": 0.1, "acc_val": 0.91},
        {"n": 200, "s": 1, "r2_val": 0.2, "acc_val": None},
        {"n": 200, "s": 1, "r2_val": 0.3, "acc_val": None},
        {"n": 200, "s": 3, "r2_val": 0.5, "acc_val": None},
        {"n": 100, "s": 1, "r2_val": 0.6, "acc_val": None},
        {"n": 100, "s": 1, "r2_val": 0.7, "acc_val": 0.1},
        {"n": 200, "s": 2, "r2_val": 0.4, "acc_val": None},
        {"n": 200, "s": 2, "r2_val": 0.3, "acc_val": 0.9},
    ]
    ...
    assert result_df.equals(
        expected_df
    ), "Expected best n, s aggregated combination calculated incorrectly for r2_val"
    ...
    # # #
    sample_data_acc = [
        {"n": 100, "s": 1, "acc_val": 0.9},
        {"n": 100, "s": 2, "acc_val": 0.91},
        {"n": 200, "s": 1, "acc_val": 0.2},
        {"n": 200, "s": 1, "acc_val": 0.3},
        {"n": 200, "s": 3, "acc_val": 0.5},
        {"n": 100, "s": 1, "acc_val": 0.6},
        {"n": 100, "s": 1, "acc_val": 0.1},
        {"n": 200, "s": 2, "acc_val": 0.4},
        {"n": 200, "s": 2, "acc_val": 0.9},
    ]
    ...
    assert result_df.equals(
        expected_df
    ), "Expected best n, s aggregated combination calculated incorrectly for acc_val"
    ...
    assert os.path.exists(
        stats_file
    ), "Empty file not created for Snakemake workflow when empty csvs were inputted"
